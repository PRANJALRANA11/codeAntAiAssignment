      ...
      <div className={`bg-white flex flex-col rounded-xl w-full border`}>
        <div className={`border-b flex flex-col p-5 w-full gap-4`}>
          <div className={`flex items-center justify-center gap-4`}>
            ...
            <span className={`font-medium text-xl`}>CodeAnt AI</span>
          </div>
          <div className={`flex justify-center text-3xl font-semibold mt-2`}>
          ...
          <div className={`flex items-center justify-center w-full`}>
            {isSaas ? (
              <div className="flex items-center flex-col justify-center w-full gap-2 max-w-[400px]">
                <a
                  href={"/dashboard"}
                  className="border items-center flex w-full gap-3 p-2 rounded-xl justify-center font-semibold"
                >
                  <img
                    src={"/svg/github.svg"}
                    alt={"github"}
